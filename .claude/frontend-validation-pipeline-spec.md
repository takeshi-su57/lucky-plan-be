...
interface ValidationStore {
  ...
  fetchCandidates: (pipelineId: string, status?: ValidationCandidateStatus) => Promise<void>;
  ...
  // Mutations
  createPipeline: (input: CreateValidationPipelineInput) => Promise<ValidationPipeline>;
  submitUserSelection: (pipelineId: string, input: UserSelectionInput) => Promise<void>;
  submitFinalApproval: (pipelineId: string, input: FinalApprovalInput) => Promise<void>;
