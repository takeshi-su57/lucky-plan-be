...
subscription BacktestTaskUpdated($taskId: ID!) {
  backtestTaskUpdated(taskId: $taskId) {
    id, status, progress
    processedConfigs, totalConfigs, currentConfig
...
subscription BacktestResultCreated($taskId: ID!) {
  backtestResultCreated(taskId: $taskId) {
    id, taskId, configId
    totalTrades, winRate, totalPnlUsdt
    sharpeRatio, profitFactor
    strategyConfig
  }
}
...
```json
{
  ...
  "filters": [],
  "risk": { "type": "atrBased", "params": { "riskPercent": 2, "stopMultiplier": 2.5 } },
...
const BACKTEST_RESULTS = gql`
  query BacktestResults($taskId: ID!, $sortBy: String, $sortOrder: String, $limit: Int, $offset: Int) {
    backtestResults(taskId: $taskId, sortBy: $sortBy, sortOrder: $sortOrder, limit: $limit, offset: $offset) {
      id
      configId
      totalTrades
...
*Document generated for frontend integration. Last updated: 2026-01-06*
