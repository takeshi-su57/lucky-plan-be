...
The worker can be shipped without cloning the repository or installing npm dependencies on the target machine. Build a portable Node 25+ release bundle:
